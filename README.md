...
* Simple `Landing` page including full-sized so-called _Hero_ background and _CTA (Click to Action) button_, whose lead into hub-section where user can navigate along different parts of the website.
* Informative `About the State`, `Things to Do`, `Food and Drinks` and `Fun Facts` pages which tells user about a such incredible place as **Edinburgh of the Seven Seas** in a several descriptive paragraphs throughout the pages.
